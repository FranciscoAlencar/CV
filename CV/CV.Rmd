...
aboutme: I am currently a Statistical doctoral student at the University of Campinas working with multivariate finite mixtures. Member of the regression models research group of the UNICAMP Statistics department. I have an interest in statistical modeling and programming languages. Challenges are welcome, as I seek to perfect my abilities and knowledge.
headcolor: 000000
...
tribble(
  ...
  "Institutional Program of Iniciation to Teaching Scholarships (PIBID)", "Federal University of Ceará", "Fortaleza, CE, Brazil", "2012 - 2013", "Development of the booklet: Simulação Estocástica usando o software livre R."
) %>%
  detailed_entries(company, dates, role, loc, details)
```

*See [here](https://github.com/FranciscoAlencar/R-software/blob/master/Stochastic_simulation_R.pdf) the booklet "Simulação Estocástica usando o software livre R"*
...
tribble(
  ...
  "Gauss - Junior enterprise", "Federal University of Ceará", "Fortaleza, CE, Brazil", "2012-2012", "Development of the booklet: Introdução ao R.", 
) %>%
  detailed_entries(company, dates, role, loc, details)
```

 See [here](https://github.com/FranciscoAlencar/R-introduction/blob/master/Apostila_R.pdf) the booklet "Introdução ao R"
